...
try:
    ...
    logging.critical("There is no DISCORD_WEBHOOK in os.environ, cannot send logs to discord.")
else:
    ...
    thread = Thread(target=webhook_handler.clear_queue_threaded, name="Thread - Discord Webhook")
    thread.start()
